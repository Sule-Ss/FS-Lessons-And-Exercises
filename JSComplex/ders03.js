...
// dot Notation(nesne elemanına ulaşma ve ya yeni eleman ekleme)
...
console.log(person); (yeni eleman ekledik.)
console.log(person.job);

// bracket Notation(köşeli parantezle ulaşma)

console.log(person['name']);
console.log(person['age']);
console.log(person['fullName']()); --> fonk.u çalıştırır 
